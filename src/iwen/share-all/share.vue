<template>
  <div>
          ...
          <ul class="clearfix">
            <li v-show="isInWx">
              <a href="javascript:void(0);" @click="shareWx"><!-- v-clipboard:copy="fullPath" v-clipboard:success="onCopy" -->
                <img src="./images/login_btn_wechat@2x.png"  />
                <p>微信</p>
              </a>
            </li>
            <li  v-show="isInWx">
              <a href="javascript:void(0);" @click="shareWx"><!-- v-clipboard:copy="fullPath" v-clipboard:success="onCopy" -->
                <img src="./images/login_btn_pyq@2x.png" alt="爱问医联" />
                <p>朋友圈</p>
              </a>
            </li>
            <li>
              <a href="javascript:;" @click="shareSina()">
                <img src="./images/login_btn_weibo@2x.png" alt="爱问医联" />
                <p>新浪微博</p>
              </a>
            </li>
          </ul>
    ...
    <div class="wechatImg" v-show="showWx" @click="shareWx">
      <img src="./images/wechat-share-tips.png" alt="爱问医联" />
    </div>

  </div>
</template>
<script>
  import LOGO_URL from "./images/icon_weibo@2x.png";
  import DEFAULT_IMG from "./images/66x66.png";
  import shareFns from "./js/share.js";
  import { APP_URL } from "@/config";
  import sysService from "@/services/sysService.js";
  // import articleService from "~/services/articleService.js";
  import jsCallSinaHealth from "@/common/jsCallSinaHealth.js";
  ...
  export default {
    ...
    methods: {
      ...
      GET_WB_LINKCARD_URL(config) {
        ...
        let linkcard = `https://health.sina.cn/linkcard/patient/business_type/${ config.type }/${ config.pid }/${ config.id }.htm?channel=${ channel }`;
