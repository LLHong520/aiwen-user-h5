    ...
    <div ref="tab" class="tab-wrapper">
      <ul class="tab-list clearfix">
        <li class="tab-item" v-for="(tabItem,index) in tabInfo"
          :key="index" :class="{'active':index==currentTab}" @click="chooseTab(index)">{{tabItem}}
        </li>
      </ul>
      ...
      <transition name="bounce">
        <div class="left-menu" v-show="show">
          <div class="menu-wrapper">
            ...
            <ul class="menu-list">
              <!-- <li class="all">全部</li> -->
              <li class="menu-item" :class="{'active':index==currentMenu}" @click="chooseMenu(index)"
...
export default {
  ...
  methods: {
    chooseTab(index){
      ...
      this.$emit("chooseTabFn",index);
    },
    chooseMenu(index){
      let This = this;
      This.a = index;
      This.hideLeftMenu();
      this.$emit("chooseMenuFn",index);
    },
    showLeftMenu() {
      this.$emit("menuFn");
    },
